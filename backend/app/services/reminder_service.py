    ...
    for meeting in _fetch_due_meetings(now):
        ...
        for uid in (meeting.get("organizer_id"), meeting.get("participant_id")):
            ...
            notify(
                ...
                "meeting_reminder",
                "Meeting starts soon",
                f"Your meeting '{meeting_title}' starts in about 30 minutes",
                {"meeting_id": meeting.get("id"), "scheduled_at": meeting_time},
                ...
                dedupe_key=f"meeting_reminder:{meeting.get('id')}:{uid}",
            )
