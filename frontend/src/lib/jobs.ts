...
/** Jobs listing with filters. `profiles` is disambiguated via the FK hint
 *  (job_applications makes the plain embed ambiguous — PostgREST PGRST201). */
...
/** AI job recommendations based on skill overlap + experience proximity. */
