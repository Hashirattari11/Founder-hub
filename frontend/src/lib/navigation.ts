...
export const NAV_BY_ROLE: Record<Role, NavItem[]> = {
  founder: [
    ...
    { label: 'AI War Room', to: '/war-room', icon: Radar },
    { label: 'AI Matches', to: '/ai-matches', icon: Target },
  ...
  investor: [
    ...
    { label: 'AI Due-Diligence', to: '/investor/due-diligence', icon: ClipboardCheck },
    { label: 'AI Matches', to: '/ai-matches', icon: Target },
    { label: 'AI Matching', to: '/ai-studio/matching', icon: Handshake },
  ...
  administrator: [
    ...
    { label: 'AI Features Admin', to: '/admin/ai-features', icon: Radar },
